...
(the twelve kernel kinds — ten until 2026-08-08, eleven until 2026-08-10), §4.2.1/§5.1 (the G3 belief-input closure), §4.3
...
`science` owns the twelve kernel kinds (kernel §4.2; ten until 2026-08-08, eleven until 2026-08-10), the relation signatures that
