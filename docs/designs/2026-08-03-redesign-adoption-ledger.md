...
> `567ebb4`, after its `nodes` prerequisite merged through `5a00bba`. Slice 2 —
> epoch publication, the four derived maps, receipts, and build behavior —
> remains outstanding.
