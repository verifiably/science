...
5. **`atoms` A8 landed 2026-08-17; the composition-root adapter design banked
   2026-08-18.** Composition-root adoption is now implementation under Plan B
   (artifact 4).
