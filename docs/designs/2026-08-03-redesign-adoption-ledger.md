...
5. **`atoms` A8 landed 2026-08-17; the composition-root adapter design banked
   ...
   remaining Plan B surface is item 2 — the family adapters and Science's
   hard cut.
