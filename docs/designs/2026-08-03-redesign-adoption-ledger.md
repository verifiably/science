...
5. **`atoms` A8 landed 2026-08-17; the composition-root adapter design banked
   2026-08-18.** Plan B item 1's implementation landed the same day
   ...
   review closed its two engine-forced deviations as design amendments. The
   remaining Plan B surface is implementation of item 2, then the deferred
   consolidate/move/deletion cut.
6. **§9 log design** after the world-index packaging design settles the anchor.
   **Banked 2026-08-03** (`2026-08-03-tamper-evident-log-design.md`);
   L1–L13 await implementation with composition-root adoption.
