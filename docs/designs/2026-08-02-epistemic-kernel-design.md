...
| Destination | Kinds |
|---|---|
| **Kernel (8; 10 since 2026-08-03)** | `proposition`, `source-assertion`*, `assessment`, `analysis-spec`*, `run`*, `verification`*, `dataset`, `source`* — plus `retraction` (correction-lifecycle) and `instrument-certification` (normative-contract 5b §7.2), which absorb nothing |
...
5b §7.2, 2026-08-03) — each of which like `verification` absorbs nothing — so
the 50 map onto 7 of the original 8.
