...
| portable unit tests | `uv run --frozen pytest tests -q` | 1,263 passed | behavior; **no** durability claim |
...
enumerated 1,263 tests; the full run reached 100% with exit code `0`. It proves
