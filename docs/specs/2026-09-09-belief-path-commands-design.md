...
**Date:** 2026-09-09
**Status:** implemented 2026-09-23; measured 2026-09-23, record `docs/records/2026-09-23-mm30-through-the-commands.md` (every prediction confirmed; the path ends in an admitted assessment and a computed belief). Amended 2026-09-23 for the kernel's typed estimand (§3, §4.3, §4.5, §5.2, §7, §8); the amendment was reviewed 2026-09-23. Goal task `sci-66b26d`.
