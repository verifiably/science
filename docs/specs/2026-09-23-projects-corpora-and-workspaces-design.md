...
- The coordination command set provides a **same-query mint**: given a view
  ...
  *Amended 2026-09-24:* the source address is carried in the new view's `body`, one act; a separate `note` record would be a second act and cannot hold a `coord:` address (coordination command set design, decision 7).
